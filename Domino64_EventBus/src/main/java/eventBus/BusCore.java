...
public class BusCore {
    ...
    /**
     * Metodo para publicar eventos. En caso de que el evento sea de tipo
     * EventoError se notifica el error a los suscriptores involucrados. En el
     * caso de los eventos normales, primero se verifica si ya existe un mapeo
     * con ese evento. Es decir, si alguien ya se suscribio para ese evento.
     *
     ...
     *
     * @param sub El suscriptor a agregar al conjunto de suscriptores para dicho
     * evento
     ...
     *
     * @param sub El suscriptor a eliminar del conjunto de suscriptores para
     * dicho evento
