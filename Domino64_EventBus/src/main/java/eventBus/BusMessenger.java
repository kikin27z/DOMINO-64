...
/**
 * Clase encargada de notificar los eventos a los suscriptores
 * de cada evento especifico
 * @author luisa M
 * @author karim F
 */
public class BusMessenger {
    ...
    public void notifyEvent(Enum<?> tipoEvento, Evento event){
        ...
        System.out.println("evento en el bus messenger: "+event.getTipo());
        subs.forEach(sub -> {
    ...
    /**
     * metodo para notificar los errores a los suscriptores.
     * Este metodo se debe usar cuando ocurre un error logico,
     * por lo tanto, lo deben llamar los manejadores logicos.
     * Si al manejar un evento generado por el usuario ocurre 
     * un error, se le debe notificar al usuario, (o tambien a
     * otros manejadores) por lo tanto, el manejador donde se 
     * genero el error debera notificarlo
