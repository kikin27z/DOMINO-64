...
/**
 * Clase que representa los datos necesarios para unirse a una partida.
 * Incluye el código de la partida a la que se desea unir y la cuenta asociada.
...
public class UnirseDTO implements Serializable {
     ...
     * 
     * @param cuenta un objeto {@code CuentaDTO} que contiene la información de la cuenta.
     */
