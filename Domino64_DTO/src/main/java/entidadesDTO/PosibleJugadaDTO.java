 ...
 * <li>{@code AMBOS_EXTREMOS}: Se puede jugar en ambos extremos del
 * tablero.</li>
 * </ul>
 *
 * Esta clase es serializable, permitiendo que las instancias puedan ser
 * enviadas entre diferentes componentes o almacenadas en sistemas que requieran
 * serialización.
 *
