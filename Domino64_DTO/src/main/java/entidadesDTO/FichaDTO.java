...
/**
 * La clase {@code FichaDTO} representa una ficha de dominó utilizada en el juego.
 * Cada ficha tiene dos valores numéricos (izquierda y derecha) que definen sus caras.
 * 
 * <p>Esta clase implementa la interfaz {@link Serializable}, lo que permite que las 
 * instancias sean serializables, facilitando su uso en sistemas distribuidos.</p>
 * 
 * <p>Proporciona métodos para determinar características de la ficha, como si es 
 ...
 * 
 * <p>Esta clase también sobrescribe el método {@link #toString()} para ofrecer 
 * una representación textual de la ficha.</p>
 * 
...
public class FichaDTO implements Serializable {
     ...
     * 
     * @return {@code true} si ambos lados son iguales, {@code false} en caso contrario
     */
     ...
     * @return {@code true} si ambas fichas son equivalentes, {@code false} en caso contrario
     */
