 ...
 * Cada avatar contiene información sobre su URL, nombre y tipo de animal.
 * Esto permite acceder a su representación visual y describir sus características.
 * 
 * @author 
 * Luisa Fernanda Morales Espinoza - 00000233450
...
public enum AvatarDTO implements Serializable {
     ...
     * 
     * @param url    Ruta de la imagen del avatar.
     * @param nombre Nombre descriptivo del avatar.
     * @param animal Tipo de animal representado por el avatar.
     */
